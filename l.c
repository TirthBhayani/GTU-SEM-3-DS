...
void main()
{
	...
	printf("3.insert node such that list is in acccending order\n");
	printf("4.delete a first node\n");
	printf("5.delete a node before specific position\n");
	printf("6.delete a node after specific positon\n");
	while(1)
	{
